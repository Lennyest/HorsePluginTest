package horseplugintest.horseplugintest.Commands;
            ...
            switch (args.length) {
                ...
                case 2:
                    if (player.hasPermission("HorseInventory.view")) {
                        ...
                        File file = new File(HorsePluginTest.getPlugin().getDataFolder().getAbsolutePath() + File.separatorChar + target.getUniqueId() + ".json");
                        if (file.exists()) {
